...
if __name__ == "__main__":
    ...
    parser.add_argument('--world_name', default="nxp", help="Name of world, see default_sdf_world_dict for options")
    ...
    if args.json_gen == 1:
        print("Using json set World parameters")
    ...
    print('Using world name: "{:s}"'.format(args.world_name))
